...
public class MyToast extends Toast
{
	 ...
	 * @return
	 */
	public static Toast makeTextAnim(Context context, CharSequence text, int duration, int styleId, int textColor)
	{
		LayoutInflater inflater = LayoutInflater.from(context);
		View view = inflater.inflate(R.layout.toast_view_center, null);
		TextView textView = (TextView) view.findViewById(R.id.toastText);
